...
let torontoHoods = "https://raw.githubusercontent.com/AndyHerron/Mapping_Earthquakes/main/torontoNeighborhoods.json";
...
L.geoJSON(data, {
  ...
  onEachFeature: function(feature, layer) {
    layer.bindPopup("<h3> Neighborhood: " + feature.properties.AREA_NAME + "<hr>")}
})
.addTo(map);
});
